...
export {
  ...
  fashionStoreCollectionSourceRegions,
} from "./contracts/pages/collection";
export {
...
export {
  fashionStoreProductSourceContract,
...
export {
  ...
  fashionStoreMagazineSourceRegions,
} from "./contracts/pages/magazine";
export {

export const zhCNMessages: Record<string, string> = {
  Notification: '通知',
  'Awaiting checkout': '待结账',
  'Order confirmed': '订单已确认',
  'Order processing': '订单处理中',
  'Order completed': '订单已完成',
  'Order canceled': '订单已取消',
  'Awaiting fulfillment': '待履约',
  'Picking items': '拣货中',
  'Items packed': '已打包',
  'Shipment dispatched': '已发货',
  'Shipment delivered': '已送达',
  'Fulfillment canceled': '履约已取消',
  'Checkout completed': '结账已完成',
  'Checkout expired': '结账已过期',
  'Checkout payment failed': '结账支付失败',
  'Checkout payment succeeded': '结账支付成功',
  'Ignored provider event': '已忽略的支付服务事件',
  'Order receipt': '订单收据',
  'Payment failure notification': '支付失败通知',
  'Cancellation notification': '订单取消通知',
  'Refund notification': '退款通知',
  'Shipment notification': '发货通知',
  'Update fulfillment': '更新履约',
  'Payment event applied': '支付事件已应用',
  'Payment event ignored': '支付事件已忽略',
  'Payment event failed': '支付事件处理失败',
  'Refund pending': '退款待处理',
  'Refund succeeded': '退款成功',
  'Refund failed': '退款失败',
  'Refund canceled': '退款已取消',
  'Notification pending': '通知待处理',
  'Notification processing': '通知处理中',
  'Notification sent': '通知已发送',
  'Notification failed': '通知发送失败',
  'Notification exhausted retries': '通知重试次数已用尽',
  'Operation succeeded': '操作成功',
  'Operation failed': '操作失败',
  'Operation denied': '操作被拒绝',

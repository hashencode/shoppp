...
- **Cross-plan execution order:** `FS-U8.2` cleanup only -> CI-U8.3 complete -> CI-U11.1 complete ->
  CI tail closure integrated into `main` -> `CI-CLOUD-U1/U2` locally complete -> `CI-CLOUD-U3`
  exact-main hosted proof -> new U8 identity freeze -> fresh U12/Preview baseline ->
...
- **Implementation tail:** Retain the completed cleanup-only tranche and integrated CI handoff,
  integrate and remotely prove the named cloud successor plus U8-specific migration on exact main,
  then execute fresh readiness, operator, refresh, Preview, and acceptance evidence and complete U8. This
  ...
  frozen candidate.
- **Last reviewed:** 2026-08-28 after the user superseded the local self-hosted runner, OrbStack,

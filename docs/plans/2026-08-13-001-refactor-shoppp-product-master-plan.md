...
- **Current parent/child stage:** `ADM-I18N-U5` — verify complete localized workflows in real browser contexts. Return to `REL-Pre-DC` after this bounded correction.
...
- **Next action:** Add real-provider browser coverage for editor recovery, Chinese controls, non-UTC dates, raw timeline data and desktop/narrow layouts under ADM-I18N U5.
...
- **Following sequence:** `ADM-I18N` U1–U6 correction and local verification -> `REL-Pre-DC` capability and identity reconciliation -> DC1 immutable
...
| `REL` | [Development Candidate Readiness](2026-08-12-003-refactor-development-candidate-readiness-plan.md) | Pre-DC/DC/PG policy and execution | **Hand-back after ADM-I18N at blocked `REL-Pre-DC` — Fashion Store implementation and FS-F2 correction are complete; capability-scope audit and full candidate-identity enforcement remain before DC1** | Owns Pre-DC reconciliation, immutable candidate identity, DC evidence, and PG state |
...
| `ADM-I18N` | [Admin Internationalization Completion](2026-09-03-1553-fix-admin-i18n-completion-plan.md) | Bounded Admin localization correction over COM/THEME/IAM | Active at U5 on 2026-09-03 | Owns audit remediation and local verification; returns to REL-Pre-DC without advancing candidate or production authority |
...
- `ADM-I18N-U5` is the single current product execution pointer and matches the active child plan; its hand-back is `REL-Pre-DC`.

...
| Root lint                                    | Repository-command baseline remains non-green: exactly 3,918 errors/0 warnings, all confined to the eight hash-pinned frozen Decor upstream vendor JavaScript files. A Decor preview-generated mirror doubles this temporarily to 7,836 until Fashion is restored. Frozen source was not rewritten to satisfy lint. |
